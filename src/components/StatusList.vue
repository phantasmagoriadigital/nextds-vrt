          ...
          <div class="flex items-center justify-between">
            <p class="flex items-center">
              ...
              <span
                ...
                :class="[
                  page.baselineImage
                    ? 'text-blue-800 bg-blue-100 hover:cursor-pointer hover:bg-blue-200'
                    : 'text-pink-800 bg-pink-100',
                ]"
              >
                <CheckIcon
                  v-if="page.baselineImage"
                  class="mr-2 w-4 h-4 text-blue-800"
                  aria-hidden="true"
                />
                Baseline
              </span>
            ...
            <div class="ml-2 flex-shrink-0 flex">
              ...
              >
                ...
                <div v-else class="text-xs" :class="[ page.status.includes('Fail') ? 'text-red-500' :'text-pink-400']">
                {{ page.status }}
                </div>
            </div>
          </div>
