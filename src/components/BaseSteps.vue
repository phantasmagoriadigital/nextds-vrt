      ...
      >
        ...
        >
          <span class="px-6 py-4 flex items-center text-sm font-medium">
            ...
            <span class="ml-4 text-sm font-medium text-pink-900">{{
              step.name
            }}</span>
          </span>
        </a>
        ...
        <a v-else :href="step.href" class="group flex items-center">
          <span class="px-6 py-4 flex items-center text-sm font-medium">
            <span
              ...
              "
            >
              <span class="text-pink-500 group-hover:text-pink-900">{{
                step.id
              }}</span>
            </span>
            <span
        ...
        <template v-if="stepIdx !== steps.length - 1">
          ...
          >
            <svg
              class="h-full w-full text-pink-300"
              viewBox="0 0 22 80"
              fill="none"
